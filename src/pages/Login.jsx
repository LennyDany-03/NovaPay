...
import { ChevronDown, LockIcon, ArrowLeft } from "lucide-react"
import { Link, useNavigate } from "react-router-dom"
import CreativeNLogo from "../components/NLogo"
import ModernGoogleButton from "../components/GoogleButton"
...
const LoginPage = () => {
  ...
  useEffect(() => {
    ...
    // Store the login source for the callback to know this is a login attempt
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white overflow-x-hidden relative flex flex-col items-center justify-center">
      ...
      >
        <Link to="/" className="flex items-center text-white/80 hover:text-white transition-colors group">
          ...
          <span className="ml-2 text-sm font-medium opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all duration-300">
            Back to Home
          </span>
        </Link>
      </motion.div>
      ...
      >
        <div className="bg-gradient-to-br from-gray-800 to-gray-900 backdrop-blur-lg rounded-2xl p-8 border border-gray-700 shadow-xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <motion.div variants={itemVariants} className="mb-10 w-32 h-32 flex items-center justify-center">
            ...
            <motion.p variants={itemVariants} className="text-lg text-gray-300 mb-8">
              Your personal space for smart, mindful money tracking.
            </motion.p>

            <motion.div variants={itemVariants} className="flex items-center justify-center w-full mb-8">
              <div className="flex items-center">
                <LockIcon className="h-5 w-5 text-purple-400 mr-2" />
                <p className="text-gray-300">Login securely to get started:</p>
              </div>
            </motion.div>
