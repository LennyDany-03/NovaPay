          ...
          >
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 backdrop-blur-lg rounded-2xl p-8 border border-gray-700 shadow-xl relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                ...
                >
                  Welcome back to NovaPay. Ready to track your finances mindfully?
                </motion.p>
                ...
                >
                  <p className="text-gray-300 mb-2">Redirecting to dashboard in <span className="text-purple-400 font-bold">{countdown}</span> seconds</p>
